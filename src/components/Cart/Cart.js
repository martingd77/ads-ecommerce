...
const Cart = () => {
    ...
    const { cartProducts, removeProductFromCart, totalPrice, clearCartContext } = useContext(CartContext)
        ...
        (
            ...
            {successOrder ? (
                <div className='container'>
                    ...
                    <Button className='btn-custom' color='secondary' variant="contained" 
                        onClick={() => finishCart()}>Finalizar gestión</Button>
                </div>
                
            ) : (
                <>
                    <div className='container'>
                        <h3>FORMULARIO DE CONFIRMACION</h3>
                        <form className='userForm' onSubmit={handleSubmit}>
                            <div className='inputs'>
                                ...
                                <Button type="submit"className='btn-custom' color='secondary' variant="contained" 
                        >Enviar</Button>
                        </form>
